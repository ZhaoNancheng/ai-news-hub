...
<div style="text-align: center; margin-top: 1.5rem;">
  <a href="/latest-news" style="display: inline-block; padding: 0.75rem 2rem; background: var(--vp-c-brand-1); color: white; border-radius: 8px; text-decoration: none; font-weight: 600;">查看完整日报 →</a>
</div>
...
- 📚 **arXiv.org** - 最新学术论文（AI Agent、多智能体系统）
- 🌐 **The Verge** - AI 行业新闻和产品发布
- 🔬 **MIT Technology Review** - 深度技术报道
- 💼 **TechCrunch** - 产业和投资动态
- 🏢 **公司博客** - OpenAI、Google、Anthropic 等
...
<div class="cta-desc">加入我们，每天获取最新的 AI 新闻、论文和工具更新</div>
...
- **GitHub**: [ZhaoNancheng/ai-news-hub](https://github.com/ZhaoNancheng/ai-news-hub)
- **Vercel**: [在线访问](https://ai-news-hub-rosy.vercel.app/)
- **反馈建议**: 欢迎提 Issue 和 PR
...
**最后更新**: 2026-02-05 08:00  
**下次更新**: 2026-02-06 08:00  
**自动化系统**: powered by [贾维斯 (JARVIS)](https://github.com/ZhaoNancheng)
